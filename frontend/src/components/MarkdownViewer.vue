...
,.markdown-viewer :deep(h3){
  margin:1.4em 0 .55em;line-height:1.3;color:#172641
}
.markdown-viewer :deep(h1){
  padding-bottom:.35em;
...
.markdown-viewer :deep(blockquote){
  margin:1em 0;
  padding:0 1em;
  border-left:4px solid #9db9ff;
  color:#64718a
}
.markdown-viewer :deep(table){display:block;overflow:auto;border-collapse:collapse}.markdown-viewer :deep(th),.markdown-viewer :deep(td){padding:7px 12px;border:1px solid #dce3ed}.markdown-viewer :deep(img){max-width:100%}
</style>
