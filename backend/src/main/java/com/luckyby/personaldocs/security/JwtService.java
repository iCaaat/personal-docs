...
public class JwtService {
    ...
    public IssuedToken createAccessToken(String username, String role) {
        return create(username, role, TokenType.ACCESS, accessExpiration);
    }

    public IssuedToken createRefreshToken(String username) {
        return create(username, null, TokenType.REFRESH, refreshExpiration);
    }
