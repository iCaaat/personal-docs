...
public class AuthController {
  ...
  public TokenSessionService.TokenPair refresh(@Valid @RequestBody RefreshRequest request) {
    ...
    try { payload = jwtService.parse(request.refreshToken()); } catch (Exception exception) { throw new org.springframework.web.server.ResponseStatusException(HttpStatus.UNAUTHORIZED, "刷新令牌无效或已过期"); }
